...
const TechGraph = () => {
  ...
  useEffect(() => {
    ...
    const CAT: Record<string, { color: string; track: string }> = {
      frontend: { color: '#4F8EF7', track: 'rgba(79,142,247,0.15)'  },
      backend:  { color: '#34C98A', track: 'rgba(52,201,138,0.15)'  },
      infra:    { color: '#F5A623', track: 'rgba(245,166,35,0.15)'  },
      data:     { color: '#A78BFA', track: 'rgba(167,139,250,0.15)' },
    };
  ...
  return (
    <div ref={wrapRef} className="relative w-full">
      ...
      <div className="flex justify-center gap-5 mt-5 flex-wrap">
        {[
          { color:'#4F8EF7', label:'Frontend'       },
          { color:'#34C98A', label:'Backend'         },
          { color:'#F5A623', label:'Infrastructure'  },
